...
function BusinessPage() {
    ...
    const businessApi='https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=96cdc7369fcb4135b3ee729e248e5b12'
    ...
    const fetchApi=async()=>{
        try{
            const response=await axios.get(businessApi)
            setFetchData(1)
    ...
    return (
        (fetchData)?
            <div className='container'>
                <h2 className='text-center text-light text-uppercase mt-5' id='top-position'>Business <i className="fa-solid fa-business-time"></i></h2>
